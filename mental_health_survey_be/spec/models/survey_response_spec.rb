...
RSpec.describe SurveyResponse, type: :model do
  describe "encryption" do
    it "encrypts and decrypts attributes correctly" do
      # Create a record
      survey = SurveyResponse.create!(today_feeling: "Happy", stress_level: 3, comments: "Test comment")
    ...
    it "validates numericality of stress_level" do
      ...
      survey = SurveyResponse.new(today_feeling: "Happy", stress_level: 10, comments: "Test comment")
    ...
    it "calculates average stress level correctly" do
      ...
      SurveyResponse.create!(today_feeling: "Happy", stress_level: 1, comments: "Test comment")
      SurveyResponse.create!(today_feeling: "Sad", stress_level: 5, comments: "Test comment")
      SurveyResponse.create!(today_feeling: "Neutral", stress_level: 3, comments: "Test comment")
